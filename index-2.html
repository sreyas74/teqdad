...
<html lang="en">
    ...
    <body>
        ...
        <!-- Hero Section Start -->
        <section class="hero-section fix hero-1 hero-2 bg-cover" style="background-image: url('assets/img/hero/hero-bg-2.jpg');">
                    ...
                    <div class="col-lg-8">
                        <div class="hero-content">
                            ...
                            <div class="hero-button">
                                <a href="about.html" class="theme-btn wow fadeInUp" data-wow-delay=".8s">
                                    Explore More
                                    <i class="fa-solid fa-arrow-right-long"></i>
                                </a>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="service-box-items style-2 active">
                            <div class="icon">
        ...
        <section class="offer-section fix section-bg-2 section-padding">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay=".8s">
                        <div class="offer-items">
                            <div class="shape-top">
                                <img src="assets/img/shape/offer-top.png" alt="shape-img">
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay=".9s">
                        <div class="offer-items">
                            ...
                            <div class="icon">
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_2517_1761)">
        ...
        <section class="tesimonial-section-2 pb-0 section-padding bg-cover" style="background-image: url('assets/img/testimonial/bg.jpg');">
            <div class="container">
                <div class="section-title-area">
                    <div class="section-title">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-box-items">
                                ...
                                <div class="client-items">
                                    <div class="client-image bg-cover" style="background-image: url('assets/img/testimonial/02.jpg');"></div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-box-items">
                                ...
                                <div class="client-items">
                                    <div class="client-image bg-cover" style="background-image: url('assets/img/testimonial/03.jpg');"></div>
                                    <div class="client-content">
                                        <h4>Albert Flores</h4>
